...
export default function SellerList() {
  ...
  const fetchSellers = async () => {
    try {
      ...
      alert("Error fetching sellers. Please check your authentication.");
    }
  };
  ...
  const handleDeleteSeller = async (sellerId) => {
    if (confirm("Are you sure you want to delete this seller?")) {
      try {
        ...
        alert("Error deleting seller: " + (error.response?.data?.message || error.message));
      }
    }
  };
  ...
  const handleVerifySeller = async (sellerId, status) => {
    try {
      ...
      alert(`Seller verification status updated to ${status}`);
      fetchSellers();
    } catch (error) {
      console.error("Verification error:", error);
      alert("Error updating verification status: " + (error.response?.data?.message || error.message));
    }
  };
